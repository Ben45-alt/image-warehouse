...
> ไฟล์นี้ไว้จดว่าทำถึงไหนแล้ว + ติดปัญหาตรงไหน (อัปเดตล่าสุด: 2026-07-16)

---

## ⏸️ จุดพักงาน (2026-07-16) — พรุ่งนี้ทำต่อ

**วันนี้ทำครบ + push production หมดแล้ว** (commit ล่าสุด `ed99471`) — รอ **ทดสอบบนเว็บจริง**

**✅ เสร็จวันนี้ (ทั้งหมด deploy แล้ว):**
- แผนหลัก 5 ฟีเจอร์: ถังขยะ30วัน · metadata ในรูป · ชื่อไฟล์ตามกิจกรรม · แชร์อัลบั้มเฉพาะคน(+audit log+auto-close+ล็อก user) · ตรวจรูปซ้ำ pHash
- ของเสริม: landing 4 การ์ด · QR Code + deep-link (สแกนเข้าเลย) · Audit Log viewer (แท็บ 📋 Log) · อัปหลายรูปทีเดียว + เอากล้องในเว็บออก
- (รายละเอียดแต่ละอันอยู่หัวข้อ "🚀 อัปเกรดใหญ่" ด้านล่าง)

**🧪 พรุ่งนี้: ทดสอบบนเว็บจริงก่อน** (image-warehouse-mis.streamlit.app)
- ⚠️ **Reboot app ก่อน** (มี lib ใหม่ qrcode/piexif ต้องติดตั้ง + module เก่าอาจค้าง)
- เช็ค: อัปหลายรูป+ถ่ายจากมือถือ · เตือนรูปซ้ำ · ถังขยะ+กู้คืน · แชร์อัลบั้ม+QR สแกนเข้า · แท็บ Log · metadata ในรูป (เปิด Properties บน Windows)
